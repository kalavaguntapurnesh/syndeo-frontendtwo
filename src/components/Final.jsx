            ...
            <div className="mx-auto max-w-[1000px] bg-[#E4E4E4] h-80 rounded">
              <div className="space-y-4">
                <div className="flex justify-center items-center pt-12">
                  <h1 className="md:text-4xl text-3xl text-footerLinks font-bold">
                    Get Started for Free
                  </h1>
                </div>

                <div className="flex justify-center items-center text-footerLinks text-center max-w-xl mx-auto ">
                ...
                <div className="flex justify-center items-center text-footerLinks text-center max-w-lg mx-auto">
                  <p>
